!(function (e, t) {
  ...
  class BaseAuthStore {
    ...
    loadFromCookie(e, t = i) {
      const s =
        (function cookieParse(e, t) {
          ...
          const i = Object.assign({}, {}).decode || defaultDecode;
          let n = 0;
          for (; n < e.length; ) {
            const t = e.indexOf("=", n);
            if (-1 === t) break;
    ...
    exportToCookie(e, t = i) {
      ...
      if (r.record && a > 4096) {
        r.record = { id: r.record?.id, email: r.record?.email };
        const s = ["collectionId", "collectionName", "verified"];
        for (const e in this.record)
          s.includes(e) && (r.record[e] = this.record[e]);
  ...
  class SettingsService extends BaseService {
    ...
    async testEmail(e, t, s, i) {
      return (
        (i = Object.assign(
          { method: "POST", body: { email: t, template: s, collection: e } },
          i
        )),
  ...
  function serializeQueryParams(e) {
    ...
    for (const s in e) {
      ...
      for (let e of n)
        (e = prepareQueryParamValue(e)), null !== e && t.push(i + "=" + e);
    }
    return t.join("&");
  }
  ...
  class RecordService extends CrudService {
    ...
    get isSuperusers() {
      return (
        "_superusers" == this.collectionIdOrName ||
        "_pbc_2773867675" == this.collectionIdOrName
      );
    }
    async subscribe(e, t, s) {
            ...
            (e._resetAutoRefresh = function () {
              ...
              (e.beforeSend = async (r, o) => {
                ...
                if (o.query?.autoRefresh)
                  return n ? n(r, o) : { url: r, sendOptions: o };
                ...
                return (
                  (o.headers = l), n ? n(r, o) : { url: r, sendOptions: o }
                );
              });
          })(
            this.client,
        ...
        this.listAuthMethods(n)
          .then((e) => {
            ...
            const o = this.client.buildURL("/api/oauth2-redirect"),
              a = r ? this.client.cancelControllers?.[r] : void 0;
            return (
              a &&
                (a.signal.onabort = () => {
                  cleanup();
                ...
                try {
                  await i.subscribe("@oauth2", async (s) => {
                    ...
                    try {
                      ...
                      const r = await this.authWithOAuth2Code(
                        n.name,
                        s.code,
                        n.codeVerifier,
                        o,
  ...
  class BatchService extends BaseService {
    ...
    collection(e) {
      return (
        this.subs[e] || (this.subs[e] = new SubBatchService(this.requests, e)),
        this.subs[e]
      );
    }
    async send(e) {
    ...
    async send(e, t) {
      ...
      return (t.fetch || fetch)(s, t)
        .then(async (e) => {
          ...
          if (
            (this.afterSend && (s = await this.afterSend(e, s, t)),
            e.status >= 400)
          )
            throw new ClientResponseError({
              url: e.url,
    ...
    initSendOptions(e, t) {
      if (
        (((t = Object.assign({ method: "GET" }, t)).body =
          (function convertToFormDataIfNeeded(e) {
            if (
